...
{
	mSPACE_INDEX[0] = (int)(mDATA.iLocation[0] / MAX_RADIUS_FOR_NETWORK);
	mSPACE_INDEX[1] = (int)(mDATA.iLocation[1] / MAX_RADIUS_FOR_NETWORK);
	mSPACE_INDEX[2] = (int)(mDATA.iLocation[2] / MAX_RADIUS_FOR_NETWORK);
}
//UPDATE
void ITEM_OBJECT::Update(int tObjectIndex)
{
	...
	mDATA.iPresentTime = GetTickCount64();
	...
	else
	{
		...
		strncpy(mDATA.iMaster, "", MAX_AVATAR_NAME_LENGTH);
...
BOOL ITEM_OBJECT::CheckPossibleGetItem(int tUserIndex)
{
	...
	if (mUTIL.GetLengthXYZ(&mDATA.iLocation[0], &mAVATAR_OBJECT[tUserIndex].mDATA.aAction.aLocation[0]) > 50.0f)
	{
		return FALSE;
	}
	if ((mDATA.iPresentTime - mDATA.iCreateTime) > 30000)
	...
	if ((strcmp(mUSER[tUserIndex].mAvatarInfo.aPartyName, "") != 0) && (strcmp(mDATA.iMaster, mUSER[tUserIndex].mAvatarInfo.aPartyName) == 0))
	{
		return TRUE;
	}
	return FALSE;
...
BOOL ZONEMAININFO::Init(void)
{
	...
	for (index01 = 0; index01 < MAX_ZONE_NUMBER_NUM; index01++)
	{
		...
		case  19: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;
		case  20: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;
		case  21: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		...
		case  34: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;
		...
		case  39: mZoneLevelInfo[index01][0] = 90; mZoneLevelInfo[index01][1] = 112; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case  49: mZoneLevelInfo[index01][0] = 10; mZoneLevelInfo[index01][1] = 112; mZoneTribeInfo[index01][0] = 11; mZoneTribeInfo[index01][1] = 1; break;
		case  50: mZoneLevelInfo[index01][0] = 100; mZoneLevelInfo[index01][1] = 112; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case  52: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case  54: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		...
		case  85: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case  86: mZoneLevelInfo[index01][0] = 150; mZoneLevelInfo[index01][1] = 153; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case  87: mZoneLevelInfo[index01][0] = 154; mZoneLevelInfo[index01][1] = 156; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case  88: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 16; mZoneTribeInfo[index01][1] = 2; break;
		...
		case  99: mZoneLevelInfo[index01][0] = 154; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case  100: mZoneLevelInfo[index01][0] = 154; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		...
		case 118: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 10; mZoneTribeInfo[index01][1] = 0; break;
		case 120: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 156; mZoneTribeInfo[index01][0] = 11; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 122: mZoneLevelInfo[index01][0] = 154; mZoneLevelInfo[index01][1] = 156; mZoneTribeInfo[index01][0] = 11; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 125: mZoneLevelInfo[index01][0] = 113;/*145;*/ mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 137: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 138: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 139: mZoneLevelInfo[index01][0] = 100; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		...
		case 144: mZoneLevelInfo[index01][0] = 113; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 145: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case 154: mZoneLevelInfo[index01][0] = 113; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = 11; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 165: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 166: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 170: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case 190: mZoneLevelInfo[index01][0] = 145; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;//113
		case 191: mZoneLevelInfo[index01][0] = 145; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;//113
		case 192: mZoneLevelInfo[index01][0] = 145; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;//113
		case 193: mZoneLevelInfo[index01][0] = 145; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;//113
		case 194: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 14; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 196: mZoneLevelInfo[index01][0] = 113; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case 197: mZoneLevelInfo[index01][0] = 123; mZoneLevelInfo[index01][1] = 132; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case 198: mZoneLevelInfo[index01][0] = 133; mZoneLevelInfo[index01][1] = 142; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case 199: mZoneLevelInfo[index01][0] = 143; mZoneLevelInfo[index01][1] = 145; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 2; break;
		case 200: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 234: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 235: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 236: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 237: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 238: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 239: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 240: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 241: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 242: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 243: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 244: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 245: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 246: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 247: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 248: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 249: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 250: mZoneLevelInfo[index01][0] = 146; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 15; mZoneTribeInfo[index01][1] = 1; break;
		...
		case 275: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;
		case 276: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;
		case 277: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		case 278: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;
		case 279: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;
		case 280: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;
		case 281: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		case 282: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;
		case 283: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;
		case 284: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;
		case 285: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		case 286: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;
		case 287: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 4; mZoneTribeInfo[index01][1] = 0; break;
		case 288: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 5; mZoneTribeInfo[index01][1] = 0; break;
		case 289: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 6; mZoneTribeInfo[index01][1] = 0; break;
		case 290: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = 7; mZoneTribeInfo[index01][1] = 0; break;
		case 291: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 292: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 293: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		case 294: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 0; break;
		...
		case 297: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 298: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 299: mZoneLevelInfo[index01][0] = 1; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 322: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		case 323: mZoneLevelInfo[index01][0] = 157; mZoneLevelInfo[index01][1] = 157; mZoneTribeInfo[index01][0] = -1; mZoneTribeInfo[index01][1] = 1; break;
		}
	}
	return TRUE;
}
...
BOOL ZONEMAININFO::CheckLevelBattleZoneNumber2()
{
...
BOOL ZONEMAININFO::Check267TypeZoneNumber2()
{
	switch (mSERVER_INFO.mServerNumber)
	{
	case 250:
...
BOOL ZONENPCINFO::CheckNPCFunction(float tCoord[3], int tMenuIndex)
{
	...
	for (index01 = 0; index01 < mDATA[(mSERVER_INFO.mServerNumber - 1)].mTotalNPCNum; index01++)
	{
		...
		if (mUTIL.GetDoubleXYZ(&mDATA[(mSERVER_INFO.mServerNumber - 1)].mNPCCoord[index01][0], &tCoord[0]) < 1000.0f)
		{
			return TRUE;
		}
	}
